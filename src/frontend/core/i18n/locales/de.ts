...
export const de: Translation = {
  ...
  widget: {
    ...
    footer: {
      'action-description': {
        ...
        'upload-pending_one': '{{count}} Datei nicht hochgeladen',
        'upload-pending_other': '{{count}} Dateien nicht hochgeladen',
      },
      errors: {
  ...
  issues: {
    ...
    errors: {
      ...
      FILE_NOT_READY: 'Die Datei wird von einem anderen Programm verwendet',
